OBJECTShelber = potPara.o merson.o legendre.o waves.o minimize1D.o minimizeND.o\
...
domgenweak: domgenweak.o $(OBJECTS) 
	$(COMPILER) -o domgenweak domgenweak.o $(OBJECTS) $(LINKOPTION)

domgen_updated: domgen_updated.o $(OBJECTS) 
	$(COMPILER) -o domgen_updated domgen_updated.o $(OBJECTS) $(LINKOPTION)
...
dom_2_kSpace : dom_2_kSpace.o $(OBJECTShelber) 
	$(COMPILER) -o dom_2_kSpace dom_2_kSpace.o $(OBJECTShelber) $(LINKOPTION)

quasipart : quasipart.o $(OBJECTShelber)
	$(COMPILER) -o quasipart quasipart.o $(OBJECTShelber) $(LINKOPTION)
